...
- GET, POST, PUT, and DELETE API calls should be directed to the appropriate routes in order to make changes to the database and subsequently update the front-end apps
